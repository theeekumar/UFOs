...
// creating function buildTable to build the table
...
// creating function handleClick to handle filtering the data
function handleClick() {
    ...
    // @NOTE: If no date was entered, then filteredData will just be the og tableData
